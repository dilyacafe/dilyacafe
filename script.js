...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const produkData = [
        ...
        { id: 3, nama: "Mie bakso", harga: 10000, gambar: "mie.webp", barcode: "mie 3", stok: 1, kategori:"makanan"},
        { id: 4, nama: "Mie scallop", harga: 15000, gambar: "mie.webp", barcode: "mie 4" , stok: 1, kategori:"makanan"},
        { id: 5, nama: "Mie siomay", harga: 11000, gambar: "mie.webp", barcode: "mie 5", stok: 1, kategori:"makanan"},
        { id: 6, nama: "Mie telur utuh", harga: 11500, gambar: "mie.webp", barcode: "mie 6", stok: 1, kategori:"makanan"},
        { id: 7, nama: "Mie sosis jumbo", harga: 12000, gambar: "mie.webp", barcode: "mie 7", stok: 1, kategori:"makanan"},
        { id: 8, nama: "Mie telur cikua", harga: 12500, gambar: "mie.webp", barcode: "mie 8", stok: 1, kategori:"makanan"},
        { id: 9, nama: "Seblak ori", harga: 7500, gambar: "seblak.webp", barcode: "seblak 1", stok: 1, kategori:"makanan"},
        { id: 10, nama: "Seblak cikuwa", harga: 8500, gambar: "seblak.webp", barcode: "seblak 2", stok: 1, kategori:"makanan"},
        { id: 11, nama: "Seblak dumpling A/K", harga: 9000, gambar: "seblak.webp", barcode: "seblak 3", stok: 1, kategori:"makanan"},
        { id: 12, nama: "Seblak Ci D A/K", harga: 10000, gambar: "seblak.webp", barcode: "seblak 4" , stok: 1, kategori:"makanan"},
        { id: 13, nama: "Seblak Ci D A/K scalop", harga: 11000, gambar: "seblak.webp", barcode: "seblak 5" , stok: 1, kategori:"makanan"},
        { id: 14, nama: "Seblak Ci D A/K ceker", harga: 12000, gambar: "seblak.webp", barcode: "seblak 6" , stok: 1, kategori:"makanan"},
        { id: 15, nama: "Seblak Ci D A/K Sc ceker", harga: 13000, gambar: "seblak.webp", barcode: "seblak 6" , stok: 1, kategori:"makanan"},
        { id: 16, nama: "Seblak Ci D A/K sosis jumbo", harga: 14000, gambar: "seblak.webp", barcode: "seblak 6" , stok: 1, kategori:"makanan"},
        { id: 17, nama: "Seblak Ci D A/K Ce telur utuh", harga: 15000, gambar: "seblak.webp", barcode: "seblak 6" , stok: 1, kategori:"makanan"},
        { id: 18, nama: "Seblak Ci D A/K Ce Sc TU", harga: 16000, gambar: "seblak.webp", barcode: "seblak 6" , stok: 1, kategori:"makanan"},
        
        { id: 19, nama: "Dimsum", harga: 10000, gambar: "dimsum.webp", barcode: "dimsum" , stok: 1, kategori:"snack"},
        { id: 20, nama: "Dimsum mentai isi 6", harga: 18000, gambar: "mentai.webp", barcode: "udang keju" , stok: 1, kategori:"snack"},
        { id: 21, nama: "Dimsum mentai isi 8", harga: 24000, gambar: "mentai.webp", barcode: "udang keju" , stok: 1, kategori:"snack"},
        { id: 22, nama: "Gyoza", harga: 10000, gambar: "gyoza.webp", barcode: "udang keju" , stok: 1, kategori:"snack"},
        { id: 23, nama: "Udang keju", harga: 10000, gambar: "udang keju.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 24, nama: "Gordil 1", harga: 10000, gambar: "gordil.webp", barcode: "gordil 1" , stok: 1, kategori:"snack"},
        { id: 25, nama: "Cireng salju goreng", harga: 5000, gambar: "cireng salju.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 26, nama: "Cireng ayam goreng", harga: 5000, gambar: "cireng ayam goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 27, nama: "Sosis goreng", harga: 5000, gambar: "sosis goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 28, nama: "Scallop goreng", harga: 5000, gambar: "scallop goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 29, nama: "Otak-otak goreng", harga: 5000, gambar: "otak-otak goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 30, nama: "Tempura goreng", harga: 5000, gambar: "tempura goreng.webp", barcode: "tempura goreng" , stok: 1, kategori:"snack"},
        { id: 31, nama: "Pentol goreng", harga: 5000, gambar: "pentol goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 32, nama: "Pentol tahu goreng", harga: 5000, gambar: "pentol tahu goreng.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        { id: 33, nama: "Mix 1", harga: 5000, gambar: "gordil.webp", barcode: "gordil 2" , stok: 1, kategori:"snack"},
        ...
        { id: 42, nama: "Es teh jumbo", harga: 2500, gambar: "esteh.webp", barcode: "esteh" , kategori:"minuman"},
        { id: 43, nama: "Es teh kecil", harga: 2000, gambar: "esteh1.webp", barcode: "esteh3" , kategori:"minuman"},
        { id: 44, nama: "Pop ice", harga: 3000, gambar: "pop ice.webp", barcode: "esteh2" , kategori:"minuman"},
        { id: 45, nama: "Nutrisari", harga: 3000, gambar: "nutrisari.webp", barcode: "rasa" , kategori:"minuman"},
        { id: 46, nama: "Gooday freze", harga: 4000, gambar: "goday freze.webp", barcode: "kopi" , kategori:"minuman"},
        { id: 47, nama: "Drink beng-beng", harga: 4000, gambar: "drink beng-beng.webp", barcode: "kopi" , kategori:"minuman"},
        { id: 48, nama: "Es Tawar", harga: 1500, gambar: "estawar.webp", barcode: "tawar" , kategori:"minuman"},
        { id: 49, nama: "Es Blewah", harga: 5000, gambar: "es blewah.webp", barcode: "blewah" , kategori:"minuman"},
        { id: 50, nama: "Es Teler", harga: 10000, gambar: "es teler.webp", barcode: "teler" , kategori:"minuman"},
        { id: 51, nama: "Es Podeng", harga: 10000, gambar: "es podeng.webp", barcode: "podeng" , kategori:"minuman"},
        { id: 52, nama: "Sop Buah", harga: 10000, gambar: "sop buah.webp", barcode: "sop buah" , kategori:"minuman"},
        { id: 53, nama: "Es boba", harga: 5000, gambar: "boba.webp", barcode: "es boba" , kategori:"minuman"},
        { id: 54, nama: "Es boba jumbo", harga: 9000, gambar: "boba.webp", barcode: "es boba jumbo" , kategori:"minuman"},
        { id: 55, nama: "Squash", harga: 4000, gambar: "squash.webp", barcode: "squash" , kategori:"minuman"},
        { id: 56, nama: "Squash jumbo", harga: 7000, gambar: "squash.webp", barcode: "squash jumbo" , kategori:"minuman"},
        { id: 57, nama: "Kopi hitam", harga: 4000, gambar: "kopi.webp", barcode: "pop ice" , kategori:"minuman"},
        { id: 58, nama: "White cofee", harga: 4000, gambar: "white cofee.webp", barcode: "pop ice" , kategori:"minuman"},
        ...
        { id: 72, nama: "Pilus", harga: 3000, gambar: "pilus.webp", barcode: "dumpling keju" , kategori:"toping"},
        { id: 73, nama: "Sosis jumbo", harga: 3000, gambar: "sosis jumbo.webp", barcode: "sosis jumbo" , kategori:"toping"},
        { id: 74, nama: "Sosis kecil", harga: 3000, gambar: "sosis kecil.webp", barcode: "sosis kecil" , kategori:"toping"},
        { id: 75, nama: "Scalop", harga: 3000, gambar: "scalop.webp", barcode: "scalop" , kategori:"toping"},
        { id: 76, nama: "Sosis sapi", harga: 3000, gambar: "sosis sapi.webp", barcode: "sosis sapi" , kategori:"toping"},
        { id: 77, nama: "spageti", harga: 3000, gambar: "spageti.webp", barcode: "spageti" , kategori:"toping"},
        { id: 78, nama: "Siomay kering", harga: 3000, gambar: "siomay kering.webp", barcode: "dumpling keju" , kategori:"toping"},
        { id: 79, nama: "Siomay sayur", harga: 3000, gambar: "siomay sayur.webp", barcode: "dumpling keju" , kategori:"toping"},
        { id: 80, nama: "Tempura", harga: 3000, gambar: "tempura.webp", barcode: "tempura" , kategori:"toping"},
        { id: 81, nama: "Telur utuh", harga: 3000, gambar: "telur utuh.webp", barcode: "telur utuh" , kategori:"toping"},
...
/* ===== FINAL KASIR HEADER BUTTONS (TEXT INSIDE) ===== */
const kasirButtonsFinal = [
 {key:'F1',  label:'Cetak',     cls:'btn-f1'},
 {key:'F2',  label:'Share',     cls:'btn-f2'},
 {key:'F3',  label:'+Produk',   cls:'btn-f3'},
 {key:'F4',  label:'Clear',     cls:'btn-f4'},
 {key:'F6',  label:'Keranjang', cls:'btn-f6'},
 {key:'F12', label:'Pesanan',   cls:'btn-f12'}
];
...
function renderKasirHeaderBar(){
 ...
 kasirButtonsFinal.forEach(b=>{
  const btn=document.createElement('button');
  btn.className=`kasir-header-btn ${b.cls}`;
  btn.innerHTML=`<span>${b.label}</span><small>${b.key}</small>`;
  btn.onclick=()=>triggerKey(b.key);
  bar.appendChild(btn);
 });
}
